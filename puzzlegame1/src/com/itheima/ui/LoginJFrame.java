...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    private void readUserInfo() {
        List<String> strings = FileUtil.readUtf8Lines("C:\\Users\\86187\\Desktop\\University\\javaDM\\puzzlegame\\userinfo.txt");
        for (String string : strings) {
            String[] strings1 = string.split("&");
            String[] arr1 = strings1[0].split("=");
            String[] arr2 = strings1[1].split("=");
